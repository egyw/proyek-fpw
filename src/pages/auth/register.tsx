...
export default function RegisterPage() {
  ...
  return (
    <div className="h-screen flex relative overflow-hidden bg-linear-to-br from-primary via-primary/90 to-primary/80">
      ...
      {/* Left Side - Benefits */}
      <div className="hidden lg:flex lg:w-1/2 p-8 xl:p-12 flex-col justify-center text-white relative z-10">
        <div className="max-w-2xl">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-sm mb-0.5">Diskon & Promo Eksklusif</h3>
                <p className="text-xs text-white/70 leading-relaxed">Nikmati penawaran menarik khusus member setiap bulan.</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-sm mb-0.5">Material Berkualitas Terjamin</h3>
                <p className="text-xs text-white/70 leading-relaxed">Semua produk berstandar SNI dan quality control ketat</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-sm mb-0.5">Return & Garansi Mudah</h3>
                <p className="text-xs text-white/70 leading-relaxed">Return dalam 7 hari dengan proses cepat tanpa ribet</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-sm mb-0.5">Pengiriman Cepat & Aman</h3>
                <p className="text-xs text-white/70 leading-relaxed">Gratis ongkir di atas 5 juta, same day delivery</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 lg:p-6 relative z-10">
        <div className="w-full max-w-lg bg-white rounded-xl shadow-2xl p-6 lg:p-8">
          <div className="mb-5">
          ...
          <Form {...form}>
            <form id="register-form" name="register-form" onSubmit={form.handleSubmit(onSubmit)} className="space-y-3">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-xs font-medium">Nama Lengkap</FormLabel>
                    <FormControl>
                      <Input
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-xs font-medium">Konfirmasi Password</FormLabel>
                    <FormControl>
                      <Input
                        type="password"
